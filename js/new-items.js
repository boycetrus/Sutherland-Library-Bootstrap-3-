...
function populateList (source, title) {
  ...
  var jsonSource = 'https://api.rss2json.com/v1/api.json?rss_url=http%3A%2F%2Fwebpac.sutherlandshire.nsw.gov.au%2Ffeeds%2F' + source + '.xml&api_key=[INSERT RSS@JSON API KEY HERE]&count=100&callback=';
